...
- [ ] 1.1 Implement PlanningSeries entity
- [ ] 1.2 Implement PlanningSlot entity as aggregate root
- [ ] 1.3 Refactor existing Event into EventInstance
...
- [ ] 2.1 Create migration for planning_series table
- [ ] 2.2 Create migration for planning_slots table
- [ ] 2.3 Create migration for event_instances table
- [ ] 2.4 Create migration for external_event_candidates table
- [ ] 2.5 Create migration for notifications table
- [ ] 2.6 Implement data migration from legacy events
...
- [ ] 5.4 Extend matrix endpoint to include deviation data
